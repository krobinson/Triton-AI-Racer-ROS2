...
"""
So we are duplicating the work here of reading from the file in donkey car and training it.
The approach here is to adapt the functions to support the ROS2 messages.
"""
